...
export const paths = {
  ...
  dashboard: {
    ...
    article: {
      root: `${ROOTS.DASHBOARD}/upload/article`,
      new: `${ROOTS.DASHBOARD}/upload/article/new`,
      list: `${ROOTS.DASHBOARD}/upload/article/list`,
      edit: (id) => `${ROOTS.DASHBOARD}/upload/article/${id}/edit`,
      view: (id) => `${ROOTS.DASHBOARD}/upload/article/${id}/view`,
    },
    audio: {
      root: `${ROOTS.DASHBOARD}/upload/audio`,
      new: `${ROOTS.DASHBOARD}/upload/audio/new`,
      list: `${ROOTS.DASHBOARD}/upload/audio/list`,
      edit: (id) => `${ROOTS.DASHBOARD}/upload/audio/${id}/edit`,
    },
    video: {
      root: `${ROOTS.DASHBOARD}/upload/video`,
      new: `${ROOTS.DASHBOARD}/upload/video/new`,
      list: `${ROOTS.DASHBOARD}/upload/video/list`,
      edit: (id) => `${ROOTS.DASHBOARD}/upload/video/${id}/edit`,
    },
    product: {
      root: `${ROOTS.DASHBOARD}/product`,
      new: `${ROOTS.DASHBOARD}/product/new`,
    ...
    upload: {
      root: `${ROOTS.DASHBOARD}/upload`,
      article: `${ROOTS.DASHBOARD}/upload/article`,
      audio: `${ROOTS.DASHBOARD}/upload/audio`,
      video: `${ROOTS.DASHBOARD}/upload/video`,
    },
    job: {
      root: `${ROOTS.DASHBOARD}/job`,
      new: `${ROOTS.DASHBOARD}/job/new`,
